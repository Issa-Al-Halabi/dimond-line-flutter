...
class NotificationHelper {
  ...
  static Future<void> showTextNotification(String title, String body,
    ...
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      channelDescription: '6valley_delivery name',
      playSound: true,
...
Future<dynamic> myBackgroundMessageHandler(RemoteMessage message) async {
  debugPrint(
      "onBackground:diamond line ${message.notification!.title}/${message.notification!.body}/${message.notification!.titleLocKey}");
