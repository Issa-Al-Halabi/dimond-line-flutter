...
class TripEndedUserScreen extends StatefulWidget {
  TripEndedUserScreen({required this.tripId, required this.finalCost, Key? key})
      : super(key: key);
  ...
  @override
  State<TripEndedUserScreen> createState() => _TripEndedUserScreenState();
}

class _TripEndedUserScreenState extends State<TripEndedUserScreen> {
