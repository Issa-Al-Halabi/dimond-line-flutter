                                      ...
                                      builder: (context, setState) {
                                        return Column(
                                          children: [
                                            ListTile(
                                              title: InkWell(
                                                child: myText(text: 'عربي', fontSize: 5.sp, color: primaryBlue,),
                                                onTap: (){
                                                  setState(() {
                                                  selectedLanguage = Languages.Arabic;
                                                  print(selectedLanguage);
                                                ...
                                                ListTile(
                                              title: InkWell(
                                                child: myText(text: 'English', fontSize: 5.sp, color: primaryBlue,),
                                                onTap: (){
                                                  setState(() {
                                                  selectedLanguage = Languages.English;
                                                  print(selectedLanguage);
                          ...
                          onTap: () {
                            ...
                            PageRouteBuilder(
                              pageBuilder: (BuildContext context,
                                  ...
                                  Animation<double> secondaryAnimation) {
                                //TODO
                                return WebViewScreen(url: 'https://diamond-line.com.sy/admin/policy',);
                              },
                              transitionsBuilder: (BuildContext context,
                                  Animation<double> animation,
                                  Animation<double> secondaryAnimation,
                            ...
                            Navigator.of(context).push(
                              PageRouteBuilder(
                                pageBuilder: (BuildContext context,
                                    ...
                                    Animation<double> secondaryAnimation) {
                                  //TODO
                                  return WebViewScreen(url: 'https://diamond-line.com.sy/admin/emergency',);
                                },
                                transitionsBuilder: (BuildContext context,
                                    Animation<double> animation,
                                    Animation<double> secondaryAnimation,
                          ...
                          onTap: () {
                              ...
                              PageRouteBuilder(
                                pageBuilder: (BuildContext context,
                                    Animation<double> animation,
                                    Animation<double> secondaryAnimation) {
                                  return ContactUsScreen(isUser: true,);
                                },
                                transitionsBuilder: (BuildContext context,
                                    Animation<double> animation,
                                    Animation<double> secondaryAnimation,
                          ...
                          onTap: () {
                              ...
                              PageRouteBuilder(
                                pageBuilder: (BuildContext context,
                                  ...
                                  return WebViewScreen(url: 'https://sub.diamond-line.com.sy',);
                                },
                                transitionsBuilder: (BuildContext context,
                                    Animation<double> animation,
                                    Animation<double> secondaryAnimation,
