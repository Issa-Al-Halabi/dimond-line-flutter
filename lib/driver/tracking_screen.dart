...
// //                                     if (data['positions'][0]['deviceId'] == 276) {
...
//     marker2 = Marker(
//       markerId: MarkerId("from"),
//       position: LatLng(double.parse(widget.pickupLatitude), double.parse(widget.pickupLongitude)),
//       rotation: 2,
//       draggable: false,
//       zIndex: 2,
//       flat: true,
...
//     marker3 = Marker(
//       markerId: MarkerId("to"),
//       position: LatLng(double.parse(widget.dropLatitude), double.parse(widget.dropLongitude)),
//       rotation: 2,
//       draggable: false,
//       zIndex: 2,
//       flat: true,
...
//   Future<void> waitForPaymentApi(String trip_id, String end_time, String finalDistance) async {
//     _isNetworkAvail = await isNetworkAvailable();
//     if (_isNetworkAvail) {
//       Loader.show(context, progressIndicator: LoaderWidget());
