...
/// data : {"id":169,"user_id":null,"first_name":"lemo","last_name":"almahdi","email":"lemar1@gmail.com","user_type":"user","father_name":"hadi","mother_name":"samia","id_entry":"","national_number":null,"phone":"0951362235","is_active":null,"date_of_birth":"8/9/2022","place_of_birth":"hama","passport_number":"51398746","profile_image":"6997356b-042a-4f52-a5c3-5ced9941b319.jpg","personal_identity":null,"driving_certificate":null,"car_mechanic":null,"car_insurance":null,"car_image":null,"group_id":null,"created_at":"2022-10-03T10:06:05.000000Z","updated_at":"2022-10-03T12:16:03.000000Z","deleted_at":null,"metas":[],"meta_data":[]}

UpdateProfilePassportModel updateProfilePassportModelFromJson(String str) => UpdateProfilePassportModel.fromJson(json.decode(str));
String updateProfilePassportModelToJson(UpdateProfilePassportModel data) => json.encode(data.toJson());
class UpdateProfilePassportModel {
  UpdateProfilePassportModel({
      bool? error, 
      String? message, 
      Data? data,}){
    _error = error;
  ...
  UpdateProfilePassportModel.fromJson(dynamic json) {
    _error = json['error'];
  ...
  String? _message;
  Data? _data;
UpdateProfilePassportModel copyWith({  bool? error,
  String? message,
  Data? data,
}) => UpdateProfilePassportModel(  error: error ?? _error,
...
/// phone : "0951362235"
/// is_active : null
/// date_of_birth : "8/9/2022"
/// place_of_birth : "hama"
/// passport_number : "51398746"
/// profile_image : "6997356b-042a-4f52-a5c3-5ced9941b319.jpg"
...
/// car_image : null
/// group_id : null
/// created_at : "2022-10-03T10:06:05.000000Z"
/// updated_at : "2022-10-03T12:16:03.000000Z"
/// deleted_at : null
/// metas : []
/// meta_data : []
