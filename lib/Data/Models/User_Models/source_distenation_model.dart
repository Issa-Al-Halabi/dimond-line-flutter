...
class SourceDistenationModel {
  SourceDistenationModel({
    bool? error,
    String? message,
    List<Data>? data,}){
    _error = error;
  ...
  SourceDistenationModel.fromJson(dynamic json) {
    _error = json['error'];
  ...
  String? _message;
  List<Data>? _data;
  SourceDistenationModel copyWith({  bool? error,
    String? message,
    List<Data>? data,
  }) => SourceDistenationModel(  error: error ?? _error,
